            ...
            <div class="flex gap-[25px] flex-wrap md:flex-nowrap justify-between">
                <div class="w-full md-w-[30%] flex flex-col gap-[15px]">
                    ...
                    <div class="w-full flex items-start flex-wrap gap-[6px] w-full">
                            ...
                            <input type="text" name="payout" class="goal-postback-filter w-[100%] bg-[#F6F6F6] px-[15px] py-[12px] text-[12px] font-[500] text-[#808080] 11border-[1px] 11border-[#E6E6E6] rounded-[10px] hover:outline-none focus:outline-none" placeholder="0.00" value="">
                       
                    </div>
                    <div class="flex gap-[10px] md:gap-[20px]">
                        <button type="submit" class="w-[100px] md:w-[110px] lg:w-[140px] bg-[#49fb53] px-[20px] py-[10px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#000] text-center">Save</button>
                    </div>
                </div>
                </form>
                <div class="w-full md-w-[70%] mt-[25px]">
                    <div class=" overflow-x-scroll tableScroll">
                        <table class="w-[100%] border-collapse border-spacing-0 rounded-[10px] border-separate border border-[#E6E6E6]">
                            <tbody>
                                <tr>
                                    <th class=" bg-[#7FB5CB] rounded-tl-[10px] text-[12px] font-[500] text-[#fff] px-[10px] py-[13px] text-left whitespace-nowrap ">App</th>
                                    <th class=" bg-[#7FB5CB] text-[12px] font-[500] text-[#fff] px-[10px] py-[13px] text-left whitespace-nowrap ">Payout</th>
                                    <th class=" bg-[#7FB5CB] text-[12px] font-[500] text-[#fff] px-[10px] py-[13px] text-left whitespace-nowrap ">IP</th>
                                    <th class=" bg-[#7FB5CB] text-[12px] font-[500] text-[#fff] px-[10px] py-[13px] text-left whitespace-nowrap ">Postback Status</th>
                                    <th class=" bg-[#7FB5CB] rounded-tr-[10px] text-[12px] font-[500] text-[#fff] px-[10px] py-[13px] text-left whitespace-nowrap text-right">Details</th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class=" text-[12px] font-[500] text-[#808080] px-[10px] py-[10px]  whitespace-nowrap  border-b-[1px] border-b-[#E6E6E6]">
                                        <div class="flex items-center justify-end gap-[10px]">
                                            <a id="{{ $postback->id }}" title="View Details" href="javascript:void(0);" class="getErrorDetails flex items-center justify-center w-[35px] bg-[#49fb53] py-[10px] w-[100px] 1border 1border-[#FED5C3] rounded-[4px] text-[14px] font-[500] text-[#000] text-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 16 16" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 8L3.07945 4.30466C4.29638 2.84434 6.09909 2 8 2C9.90091 2 11.7036 2.84434 12.9206 4.30466L16 8L12.9206 11.6953C11.7036 13.1557 9.90091 14 8 14C6.09909 14 4.29638 13.1557 3.07945 11.6953L0 8ZM8 11C9.65685 11 11 9.65685 11 8C11 6.34315 9.65685 5 8 5C6.34315 5 5 6.34315 5 8C5 9.65685 6.34315 11 8 11Z" fill="#000"/>
                                            </svg> 
                                            </a>
                                        </div>
                                    </td>
...
<div id="errorDetailsModal" class="hidden fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
    <div class="bg-white p-5 rounded-lg shadow-lg w-[90%] max-w-[700px]">
        ...
        <button onclick="$('#errorDetailsModal').addClass('hidden');" class="mt-4 bg-[#49fb53] text-[#000] px-4 py-2 rounded">Close</button>
    </div>
</div>
