...
<div class="bg-[#090B13] pl-[20px] pr-[20px] 2xl:pl-[20px] 2xl:pr-[20px] py-[10px] 2xl:py-[10px] pt-[2px] sidebar">
    <div class="mb-[20px] 2xl:mb-[50px]">
        <a href="{{ route('dashboard.index') }}"
            class=" group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='dashboard.index') active @endif">
    ...
    <div class="mb-[20px] 2xl:mb-[50px]">
        ...
        <a href="{{ route('report.statistics') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='report.statistics') active @endif">
        ...
        <a href="{{ route('report.conversions') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='report.conversions') active @endif">
        ...
        <a href="{{ route('report.postbacks') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='report.postbacks') active @endif">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        {{-- <a href="{{ route('report.exported') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='report.exported') active @endif">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <div class="mb-[20px] 2xl:mb-[50px]">
        ...
        <a href="{{ route('apps.index') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='apps.index') active @endif">
        ...
        <a href="{{ route('apps.add') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='apps.add') active @endif">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="{{ route('testPostback') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='testPostback') active @endif">
    ...
    <div class="mb-[20px] 2xl:mb-[50px]">
        ...
        {{-- <a href="#" class=" group flex items-center gap-[10px] px-[10px] py-[10px] text-[14px] font-[400] text-[#918191] hover:text-[#ce68ce] active:text-[#ce68ce]] ">
            <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="{{ route('documentations') }}"
            class="group flex items-center gap-[10px] px-[10px] py-[10px] text-[16px] font-[400] text-[#918191] hover:text-[#ce68ce] @if(Route::currentRouteName()=='documentations') active @endif">
