...
<div class="p-[15px] md:p-[35px]">
    {{-- <div class="bg-[#fff] p-[10px] md:p-[15px] md:p-[20px] rounded-[5px] md:rounded-[10px] mb-[20px]">
        <div class="flex gap-[10px] md:gap-[25px] w-[100%] ">
            ...
            <button
                class="bg-[#49FB53] px-[20px] py-[12px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#000] text-center">Search</button>
        </div>
    </div>
    ...
    <div class="flex items-stretch justify-between flex-wrap md:flex-nowrap gap-[20px]">
        <div class="flex flex-col gap-[5px] w-[100%] md:w-[100%] bg-[#fff] rounded-[5px] md:rounded-[10px] p-[15px]">
            ...
            <div
                class="flex items-center gap-[20px] p-[15px] bg-[#d9ffdb] border-[1px] border-[#49fb53] rounded-[8px] h-[100px]">
        ...
        <div class="flex flex-col gap-[10px] w-[100%] md:w-[100%] bg-[#fff] rounded-[5px] md:rounded-[10px] p-[15px]">
            ...
            <div
                class="flex items-center justify-between gap-[20px] p-[15px] bg-[#d9ffdb] border-[1px] border-[#49fb53] rounded-[8px] h-[60px]">
    ...
    <div class="flex items-center justify-between gap-[20px] mt-[20px]">
        <div class="flex justify-between items-start md:items-center flex-col md:flex-row gap-[15px] w-[100%] bg-[#fff] rounded-[5px] md:rounded-[10px] p-[15px]">
            <div class="flex flex-col gap-[5px]">
                ...
                <button class="flex items-center justify-center w-[170px] md:w-[170px] px-[4px] py-[12px] md:px-[15px] md:py-[12px] rounded-[5px] bg-[#49FB53]  hover:bg-[#000] text-[12px] md:text-[14px] font-[500] text-[#000] hover:text-[#fff]">Enter Now Payments</button>
            </div>
            ...
            <div class="w-[100%] overflow-x-auto tableScroll">
                <table class="w-[100%] border-collapse border-spacing-0 rounded-[10px] border-separate border border-[#E6E6E6]">
                    <tr>
                        ...
                        <th class="bg-[#7FB5CB] text-[14px] font-[500] text-[#fff] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            Amount</th>
                        <th class="bg-[#7FB5CB] text-[14px] font-[500] text-[#fff] px-[10px] py-[13px] text-left  whitespace-nowrap">Due
                            Date</th>
                        <th class="bg-[#7FB5CB] text-[14px] font-[500] text-[#fff] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            Payment Date</th>
                        <th class="bg-[#7FB5CB] text-[14px] font-[500] text-[#fff] px-[10px] py-[13px] text-left  whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="text-[14px] font-[500] text-[#808080] px-[10px] py-[10px] text-left  whitespace-nowrap ">
                            <button
                                class="inline-flex bg-[#F3FEE7] border border-[#BCEE89] rounded-[5px] px-[10px] py-[4px] text-[12px] font-[600] text-[#6EBF1A] text-center uppercase"><svg
                ...
                <div class="pagination mt-[20px] flex gap-[10px] items-center justify-end">
                    ...
                    <a href="https://admin.offawall.com/affiliates?page=1&amp;status=" class="btn-active btn inline-flex gap-[8px] items-center bg-[#fff] border border-[#E6E6E6] rounded-[5px] px-[10px] py-[4px] text-[12px] font-[600] text-[#808080] text-center hover:bg-[#4EF953] hover:text-[#000]">
    1
</a>
                    <a href="https://admin.offawall.com/affiliates?page=2&amp;status=" class="btn inline-flex gap-[8px] items-center bg-[#fff] border border-[#E6E6E6] rounded-[5px] px-[10px] py-[4px] text-[12px] font-[600] text-[#808080] text-center hover:bg-[#4EF953] hover:text-[#000]">
    2
</a>
                    <a href="https://admin.offawall.com/affiliates?page=3&amp;status=" class="btn inline-flex gap-[8px] items-center bg-[#fff] border border-[#E6E6E6] rounded-[5px] px-[10px] py-[4px] text-[12px] font-[600] text-[#808080] text-center hover:bg-[#4EF953] hover:text-[#000]">
    3
</a>
                    <a href="https://admin.offawall.com/affiliates?page=4&amp;status=" class="btn inline-flex gap-[8px] items-center bg-[#fff] border border-[#E6E6E6] rounded-[5px] px-[10px] py-[4px] text-[12px] font-[600] text-[#808080] text-center hover:bg-[#4EF953] hover:text-[#000]">
    4
</a>
            
                    <a href="https://admin.offawall.com/affiliates?page=2&amp;status=" class="btn group inline-flex gap-[5px] items-center bg-[#fff] border border-[#E6E6E6] rounded-[5px] px-[10px] py-[4px] text-[12px] font-[600] text-[#000] text-center hover:bg-[#4EF953] hover:text-[#000]">Next <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1 1L5 5L1 9" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="group-hover:stroke-[#fff] "></path>
</svg></a>
            </div>
            </div>
        </div>
