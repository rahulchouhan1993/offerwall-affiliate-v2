            ...
            <div class="flex flex-wrap md:flex-nowrap items-start gap-[10px] w-[100%] xl:w-[33%]">
                <div class="w-[100%]">
                   ...
                   <div class="w-[100%] xl:w-[20%] flex items-center justify-start xl:justify-between gap-[10px]">
                    <button class="w-[80px] md:w-[90px] lg:w-[100px] xl:w-[130px] 2xl:w-[140px] bg-[#49FB53] px-[3px] py-[12px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#000] text-center">Apply</button>

                        <a href="{{ route('report.postbacks') }}" class="w-[80px] md:w-[90px] lg:w-[100px] xl:w-[130px] 2xl:w-[140px] bg-[#536861] px-[20px] py-[10px] w-[100px] border border-[#F5EAF5] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center">Clear</a>
                   </div>
                </div></div>
             </div>
